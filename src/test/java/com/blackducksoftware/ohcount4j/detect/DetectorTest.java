...
public class DetectorTest {
	...
	public Object[][] detectByExtensions() {
		return new Object[][] { { Language.C, Arrays.asList("main.c") }, { Language.CSS, Arrays.asList("main.css") },
				{ Language.HTML, Arrays.asList("main.htm", "main.html") },
				{ Language.JAVA, Arrays.asList("main.java") }, { Language.JAVASCRIPT, Arrays.asList("main.js") },
				...
				{ Language.GOLANG, Arrays.asList("main.go") }, { Language.AUGEAS, Arrays.asList("main.aug") },
				{ Language.AWK, Arrays.asList("main.awk") }, { Language.BRAINFUCK, Arrays.asList("main.bf") },
				{ Language.BFPP, Arrays.asList("main.bfpp") },
				{ Language.CMake, Arrays.asList("CMakeLists.txt", "file.cmake") },
				{ Language.CHAISCRIPT, Arrays.asList("main.chai") }, { Language.COQ, Arrays.asList("foo.v") },
				{ Language.CUDA, Arrays.asList("foo.cu", "foo.cuh") }, { Language.BLITZMAX, Arrays.asList("main.bmx") },
				{ Language.FORTH, Arrays.asList("foo.fr", "foo.4th") }, { Language.DCL, Arrays.asList("foo.COM") },
